...
- **Change the favicon** to your own icon
- **Change the logo** to your own logo/ photo
- **Change the title** to your own title (in `_layouts/default.html`)
- **Change the preview image** to your own image (it contains my face, please remove it)
